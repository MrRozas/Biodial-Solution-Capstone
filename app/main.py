...
imagen_fondo = Image.open("./app/images/biodial.jpeg")  # Reemplaza con la ruta de tu imagen de fondo
...
boton_excel = tk.Button(frame_botones, text="Abrir Excel", command=lambda:abrir_excel("./app/Clasificacion y factor de Consumo Biodial.xlsx"), height=2, width=100)
boton_abrir = tk.Button(frame_botones, text="Abrir Imagen", command=abrir_imagen, height=2, width=100)
boton_abrir_con_ruta = tk.Button(frame_botones, text="Abrir Imagen con Ruta", command=lambda: mostrar_imagen("./app/images/pronostico.PNG"), height=2, width=100)
